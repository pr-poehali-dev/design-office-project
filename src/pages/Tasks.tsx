        ...
        <div className="px-4 md:px-8 py-6">
          ...
          {loading ? (
            ...
            <>
              ...
              <TaskBoardView tasks={filtered} onStatusChange={handleStatusChange} showModal={showModal} onCloseModal={() => setShowModal(false)} onAddTask={handleAddTask} projects={projects} />
            </>
          )}
        </div>
      </main>
